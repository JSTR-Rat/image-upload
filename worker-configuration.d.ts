/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2f54bec25485494cfc34f40f6b0692e)
// Runtime types generated with workerd@1.20260507.1 2026-04-20 nodejs_compat
declare namespace Cloudflare {
	interface StagingEnv {
		CDN_BUCKET: R2Bucket;
		DB: D1Database;
		BETTER_AUTH_URL: "https://staging.img.jstr.sh";
		BETTER_AUTH_SECRET: string;
	}
	interface ProductionEnv {
		CDN_BUCKET: R2Bucket;
		DB: D1Database;
		BETTER_AUTH_URL: "https://img.jstr.sh";
		BETTER_AUTH_SECRET: string;
	}
	interface Env {
		CDN_BUCKET: R2Bucket;
		DB: D1Database;
		BETTER_AUTH_URL: "https://staging.img.jstr.sh" | "https://img.jstr.sh" | "http://localhost:3000";
		BETTER_AUTH_SECRET: string;
	}
}
